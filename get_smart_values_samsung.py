        ...
        for p in self.parameters:
            for l in proc_stdout[0].strip().split('\n'):
                if p[0] in l:
                    ...
                    elif p[1] == 182: out.abec = int(line[9])
                    elif p[1] == 179: out.urnb = int(line[9])
                    elif p[1] == 194: out.et = int(line[9])
                    elif p[1] == 179: out.rec = int(line[9])
                    elif p[1] == 177: out.plr = int(line[9])
                    elif p[1] == 241: out.hpnpc = int(line[9])
                    elif p[1] == 241: out.fpnpc = int(line[9])
        return out
